 ...
 * @version $Id: platform.php 158 2010-06-10 08:46:49Z nikosdion $
 */
...
class AEPlatform
{
	 ...
	 * @return array
	 */
	function &get_statistics_list($limitstart = null, $limit = null)
	{
		$db =& AEFactory::getDatabase( self::get_platform_database_options() );
	 ...
	 * @return unknown_type
	 */
	public static function get_running_backups()
	{
		$db =& AEFactory::getDatabase( self::get_platform_database_options() );
		$query = "SELECT * FROM ".$db->nameQuote('#__ak_stats') .
