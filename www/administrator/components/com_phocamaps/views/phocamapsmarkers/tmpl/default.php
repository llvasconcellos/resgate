	...
	<?php
		...
		if (is_array($rows)) {
			foreach ($rows as $row) {
				...
				$link 		= JRoute::_( 'index.php?option=com_phocamaps&controller=phocamapsmarker&task=edit&cid[]='. $row->id );
				$linkCatid	= JRoute::_( 'index.php?option=com_phocamaps&controller=phocamapsmap&task=edit&cid[]='. $row->catid );
				?>
