...
class Gantry {
    ...
    function _getBrowserBasedChecks($filename) {
        $checks = array(
			...
			// browser check
			$filename . '-' . $this->browser->name,

			// plat			form check
			$filename . '-' . $this->browser->platform,

			// brow			ser + platform check
			$filename. '-' . $this->browser->name . '-' . $this->browser->platform,

			// shor			t browser version check
			$filename. '-' . $this->browser->name . $this->browser->shortversion,

			// long			 browser version check
			$filename . '-' . $this->browser->name . $this->browser->version,

			// shor			t browser version + platform check
			$filename. '-' . $this->browser->name . $this->browser->shortversion . '-' . $this->browser->platform,

			// long			 browser version + platform check
			$filename . '-' . $this->browser->name . $this->browser->version . '-' . $this->browser->platform
		);
