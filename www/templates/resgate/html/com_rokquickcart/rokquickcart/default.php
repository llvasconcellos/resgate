<div class="cart_quickcart">
    	    ...
    	    <div class="cart_product_content">
    	   		<div class="cart_padding">
	    	   		<div class="cart_product_l">
	        	        ...
	        	        <img src="<?php echo $item->getShelfImage();?>" alt="<?php echo $item->name;?>" title="<?php echo $item->name;?>" class="item_image"/>
    ...
    <div class="clr"></div>
    <a id="rokquickcart"></a>
    <div><?php echo JText::_('ROKQUICKCART.YOUR_CART');?>: (<span class="simpleCart_quantity"></span> <?php echo JText::_('ROKQUICKCART.ITEMS');?>)</div>
    ...
    <div class="cart_buttons">
        <a href="javascript:;" class="readon simpleCart_checkout"><span><?php echo JText::_('ROKQUICKCART.CHECKOUT');?></span></a>
        <a href="javascript:;" class="readon simpleCart_empty"><span><?php echo JText::_('ROKQUICKCART.EMPTY_CART');?></span></a>
    </div>
    <div class="clr"></div>
</div>
