		...
		<div id="rt-mainbg-overlay">
			<div class="rt-surround-wrap"><div class="rt-surround"><div class="rt-surround2"><div class="rt-surround3">
				<div class="rt-container">
					...
					<?php /** End Top **/ endif; ?>
					<div id="rt-header-wrap"><?php //if(($_REQUEST['option'] == "com_content") && ($_REQUEST['view'] == 'frontpage')): ?>
						<object data="monoslideshow/monoslideshow.swf" type="application/x-shockwave-flash" height="200" width="960">
							<param name="src" value="monoslideshow.swf" />
							<param name="wmode" value="transparent" />
							<param name="flashvars" value="showLogo=false&amp;dataFile=monoslideshow/slideshow.xml.php" />
						</object>
						<img id="slogan" src="images/slogan_1.png" style="position: absolute; margin-top: 150px; margin-left: -560px" />
						<div style="height: 80px"></div>
						<div id="rt-header-wrap2" style="position:absolute;top:0px">
						<script language="javascript">
							var i = 1;
							var slogan = document.getElementById('slogan');
							function rotacionaSlogan(){
								var src = 'images/slogan_';
								if(i == 1){
									slogan.src = src + i + '.png';
									i = 2;
								}
								else if(i == 2){
									slogan.src = src + i + '.png';
							...
							window.setInterval(rotacionaSlogan, 5000);
						</script>
